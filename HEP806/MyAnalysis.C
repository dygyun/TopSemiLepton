...
void MyAnalysis::GetMuSF() {                                                                         
   TFile *MuSF = TFile::Open("/cms/scratch/dygyun/v806/MuJet/EfficienciesAndSF_GH_Sep_promptReco_MC_Moriond.root"); // IDISO mu   
   TFile *MuIsoSF = TFile::Open("/cms/scratch/dygyun/v806/MuJet/EfficienciesAndSF_GH_IsoSF.root"); // IDISO mu   
...
//         cout << "test MuSF : "<< h_Muid_sf->GetName() << endl;                                          
