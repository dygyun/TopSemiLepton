#ifndef MyAnalysis_Sig_h
#define MyAnalysis_Sig_h
#include <TROOT.h>
#include <TFile.h>
#include <TChain.h>
#include <TSelector.h>
...
class MyAnalysis_Sig: public TSelector {
public:
   ...
   MyAnalysis_Sig(float sf = 1., float wf = 1, float Xsection = 1.0 , float lumi = 1.0, float num = 1.0,  TTree * /*tree*/= 0) :
   //MyAnalysis_Sig(float sf = 1., float wf = 1, float Xsection = 1.0 , float lumi = 1.0, TTree * /*tree*/= 0) :
...
#ifdef MyAnalysis_Sig_cxx
void MyAnalysis_Sig::Init(TTree *tree)
{
   ...
   fChain->SetBranchAddress("CSVWeight", &CSVWeight);
...
Bool_t MyAnalysis_Sig::Notify()
{
   return kTRUE;
}
#endif // #ifdef MyAnalysis_Sig_cxx
